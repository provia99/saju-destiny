...
function generate(slotId) {
  ...
  if (fs.existsSync(masterPath)) {
    try {
      ...
      _r = 전체사주계산({이름:_m.이름,성별:_m.성별,년:_m.생년,월:_m.생월,일:_m.생일,시간:_m.생시||'모름',음력입력:!!_m.음력입력,윤달:!!_m.윤달});
    } catch(e) {}
  }
...
<div class="card">
  ...
  <div class="right">
    <div class="item"><span class="label">양력</span><span class="value">${양력}</span></div>
    <div class="item"><span class="label">음력</span><span class="value">${음력}</span></div>
